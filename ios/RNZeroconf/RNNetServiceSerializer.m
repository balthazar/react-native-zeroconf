...
const NSString *kRNServiceTxtRecord = @"txt";
                                       ...
                                       resolved:(BOOL)resolved
{
    ...
    if (resolved) {
        ...
        NSString* txtStr = [[NSString alloc] initWithData:service.TXTRecordData encoding:NSASCIIStringEncoding];
        serviceInfo[kRNServiceTxtRecord] = txtStr;
    }
